...
export function Header() {
  ...
  return (
    <header className="sticky top-0 flex h-20 md:h-24 items-center justify-between rounded-lg px-4 border-b border-border bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl shadow-md transition-all duration-300">
      {/* Esquerda: Navegação */}
